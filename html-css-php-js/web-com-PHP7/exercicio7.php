...
<body>
 <h1> Fundamentos de PHP - Exercício 7 da ListaL2 - Resposta do PHP </h1>
 ...
 <?php
  ...
  {
    echo "<p> Aviso: pagamento deve ser informado. </p>";
    exit();
  }
    // reutilizar 
    ...
    {
      echo "<p> Aviso: a entrega domicílio deve ser informada. </p>";
      exit();
    }
