<?php
 ...
 if($conexao->affected_rows == 1) //se retornar 1, é pq já existem um login/email cadastrado igual, se retornar 0 é pq está tudo ok com o cadastro (não tem ninguém com email/login igual)
  {
